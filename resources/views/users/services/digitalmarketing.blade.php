...
<head>
  ...
  <title>Creative Digital - Digital Marketing</title>
  ...
  <header class="bg-white shadow-md sticky top-0 z-50">
    <div class="container mx-auto flex items-center justify-between py-4 px-6">
      ...
      <h1 class="flex items-center space-x-2 text-xl font-bold text-blue-500">
        <img src="img/logoc.png" alt="Logo" class="h-12 w-12 object-contain">
        <span>Creative Digital</span>
      </h1>

      <!-- Nav Links Desktop -->
      <nav class="hidden lg:flex items-center space-x-6">
        <a href="index.html" class="nav-link hover:text-blue-600">Home</a>
        <a href="tentangkami.html" class="nav-link hover:text-blue-600">Tentang Kami</a>
        <a href="webdesain.html" class="nav-link hover:text-blue-600">Web Desain</a>
        <a href="webdevelopment.html" class="nav-link hover:text-blue-600">Web Development</a>
        <a href="digitalmarketing.html" class="nav-link hover:text-blue-600 font-semibold text-blue-600">Digital Marketing</a>
      </nav>
    ...
    <div id="menu" class="hidden lg:hidden bg-white shadow-md">
      <ul class="flex flex-col space-y-2 px-6 py-4">
        ...
        <li><a href="tentangkami.html" class="block py-2 hover:text-blue-600">Tentang Kami</a></li>
        <li><a href="webdesain.html" class="block py-2 hover:text-blue-600">Web Desain</a></li>
        <li><a href="webdevelopment.html" class="block py-2 hover:text-blue-600">Web Development</a></li>
        <li><a href="digitalmarketing.html" class="block py-2 hover:text-blue-600 font-semibold text-blue-600">Digital Marketing</a></li>
      </ul>
